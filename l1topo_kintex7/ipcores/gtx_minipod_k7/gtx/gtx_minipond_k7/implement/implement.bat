...
COPY gtx_minipond_k7_exdes.ngc .\results
cd .\results

REM Run ngdbuild

ngdbuild -uc ..\..\example_design\gtx_minipond_k7_exdes.ucf -p xc7k325t-fbg900-2 gtx_minipond_k7_exdes.ngc gtx_minipond_k7_exdes.ngd
...
ECHO 'Running NGD'
map -register_duplication on -logic_opt on -timing -ol high -p xc7k325t-fbg900-2 -o mapped.ncd gtx_minipond_k7_exdes.ngd
...
netgen -ofmt vhdl -sim -dir . -tm gtx_minipond_k7_exdes -w routed.ncd routed.vhd
