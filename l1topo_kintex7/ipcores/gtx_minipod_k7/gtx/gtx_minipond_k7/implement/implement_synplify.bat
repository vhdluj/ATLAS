...
COPY gtx_minipond_k7_exdes.edf .\results
cd .\results

REM Run ngdbuild

ngdbuild -uc ..\..\example_design\gtx_minipond_k7_exdes.ucf -p xc7k325t-fbg900-2 gtx_minipond_k7_exdes.edf gtx_minipond_k7_exdes.ngd
...
ECHO 'Running NGD'
map -p xc7k325t-fbg900-2 -o mapped.ncd gtx_minipond_k7_exdes.ngd
